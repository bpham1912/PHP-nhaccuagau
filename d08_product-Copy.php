...
<link href="assets/css/font-awesome_1.css" rel="stylesheet" type="text/css"/>-->
<!--=================================
Style Sheets
=================================-->
...
<header>
  ...
  <nav class="navbar yamm navbar-default">
        ...
        <div class="nav_scroll">
          ...
          <ul class="nav navbar-nav">
            ...
            <li><a href="news.html">Contact</a></li>
             <li class="dropdown"><a href="#">Account <i class="fa fa-caret-right"></i></a>
              <ul class="dropdown-menu">
                   <div class="container">
    ...
    <body>
        <h1 style="color: black">Login and experience</h1>
            ...
            <div class="content-wthree">
                ...
                <form action="#" method="post">
                    <div class="inputs-w3ls">
                        ...
                        <i style="color:black">Username:&emsp;</i><input type="text" name="Username" placeholder="Username" required=""/>
                    </div>
                    <div class="inputs-w3ls">
                        <i class="fa fa-key" aria-hidden="true"></i>
                       <i style="color:black">Password:&emsp;</i><input type="password" name="Password" placeholder="Password" required=""/>
                    </div>
     ...
     <div class="container">
    <button type="button" class="btn btn-info btn-lg" data-toggle="modal"
    data-target="#myyModal">REGISTER</button>
    <div id="myyModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
        ...
        <div class="signupform">
            <h1 style="color: black">REGISTER AN ACCOUNT</h1>
            <div class="container">
                ...
                <div class="agile_info">
                    <div class="w3_info">
                        <form action="#" method="post">
                            ...
                            <div class="left">
                                ...
                                <div class="sa">
                                    <div class="sas">
                                        <span class="sass1">Nữ</span><input type="radio" name="rdGender" value="nu" checked>
                                        <span class="sass1">Nam</span><input type="radio" name="rdGender" value="nam" checked
                                          <span class="sass1">Khác</span><input type="radio" name="rdGender" value="khac" checked>
                    ...
                    <div class="w3l_form">
                        <div class="left_grid_info">
                            <h3>Welcome to nhaccuagau</h3>
                            <p> Welcome to nhacuagau. Sign up for an account and experience the great songs and videos on our website. </p>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-3 col-md-3 col-sm-3">
        ...
        <div class="latest-tweet" data-username="@hmtam0903" data-limit="2"></div>
      </div>
      <!--\\column-->
      
      <div class="col-lg-3 col-md-3 col-sm-3">
        <h4><span class="fa fa-flickr"></span>Flicker Feed</h4>
        <ul id="flicker-feed" data-limit="6" data-userID="135884794@N05"></ul>
      </div>
      <!--\\column-->
